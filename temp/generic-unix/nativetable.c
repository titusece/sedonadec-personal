...
Cell web_BACnetDev_doBacnetValueStatus(SedonaVM* vm, Cell* params);

// int BACnetDev.doBacnetPriorityStatus(int, bool)
Cell web_BACnetDev_doBacnetPriorityStatus(SedonaVM* vm, Cell* params);

// int BACnetDev.doBacnetOverrideStatus()
Cell web_BACnetDev_doBacnetOverrideStatus(SedonaVM* vm, Cell* params);

// int BACnetDev.doBacnetValueUpdate(bool, bool, int)
Cell web_BACnetDev_doBacnetValueUpdate(SedonaVM* vm, Cell* params);

// int BACnetDev.doBacnetInitStatus()
Cell web_BACnetDev_doBacnetInitStatus(SedonaVM* vm, Cell* params);

// int BACnetDev.dowebValueUpdate()
Cell web_BACnetDev_dowebValueUpdate(SedonaVM* vm, Cell* params);

// int BACnetDev.dowebValueReceive()
Cell web_BACnetDev_dowebValueReceive(SedonaVM* vm, Cell* params);

// native table for kit 85
NativeMethod kitNatives85[] = 
{
  web_BACnetDev_doBacnetInit,     // 85::0
  web_BACnetDev_doBacnetValueStatus,  // 85::1
  web_BACnetDev_doBacnetPriorityStatus,  // 85::2
  web_BACnetDev_doBacnetOverrideStatus,  // 85::3
  web_BACnetDev_doBacnetValueUpdate,  // 85::4
  web_BACnetDev_doBacnetInitStatus,  // 85::5
  web_BACnetDev_dowebValueUpdate,  // 85::6
  web_BACnetDev_dowebValueReceive,  // 85::7
};
